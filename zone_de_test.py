...
class grid:
    def __init__(self, sq1, sq2, sq3, sq4):
        ...
        self.list_init = [sq1.list_all, sq2.list_all, sq3.list_all, sq4.list_all]
        ...
        for x in range(0, 4):
            ...
            for y in range(0, 4):
                ...
                aa = eval(f"{y}//2") + eval(f"({x}//2)*2")
                ab = eval(f"{y}%2") + eval(f"({x}%2)*2")
                ref = str(aa) + "-" + str(ab)
        ...
        self.MyGrid=NewGrid
        print(f"Th initial grid was : {self.MyGrid}")

        self.list_lines = [[*"l" * 4], [*"l" * 4], [*"l" * 4], [*"l" * 4]]
        self.list_cols = [[*"c" * 4], [*"c" * 4], [*"c" * 4], [*"c" * 4]]
        self.list_sqs = [[*"s" * 4], [*"s" * 4], [*"s" * 4], [*"s" * 4]]
